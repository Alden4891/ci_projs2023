...
function message_get_subject($data){
    foreach ($data->payload->headers as $key => $header) {
        // print_r($key);
...
// print_r($data->threadId);

$subject  = message_get_subject($data);
$body = $data->snippet;
$thread_id = $data->threadId;

// print("Thread_id: $thread_id <br>");
...
// print_r($data->payload->headers[3]->name);
// print('</pre>');
